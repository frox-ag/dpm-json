...
Below a example of the same logic written in Javascript with Spin and with Groovy-dpmJson. Both examples return a list containing all even numbers of the following list called *myList*:
```
[0, 1, 2, 3]
```
...
## Get started
Clone this repository and clean install it to your local maven repository. Then add it to your pom.xml dependencies:

```
            <dependencies>
                ...
                <dependency>
                    <groupId>org.frox.opendpm</groupId>
